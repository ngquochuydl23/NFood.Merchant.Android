...
import kotlinx.android.synthetic.main.fragment_current_promotion.*

class CurrentPromotionFragment : BaseFragment() {

  override fun onCreateView(
    inflater: LayoutInflater, container: ViewGroup?,
    savedInstanceState: Bundle?
  ): View? {
    return inflater.inflate(R.layout.fragment_current_promotion, container, false)
  }
