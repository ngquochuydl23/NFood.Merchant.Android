...
import kotlinx.android.synthetic.main.fragment_coming_promotion.*


class ComingPromotionFragment : Fragment() {

 override fun onCreateView(
    inflater: LayoutInflater, container: ViewGroup?,
    savedInstanceState: Bundle?
  ): View? {
    return inflater.inflate(R.layout.fragment_coming_promotion, container, false)
  }
